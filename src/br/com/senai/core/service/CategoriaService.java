...
public class CategoriaService {
	...
	public Categoria buscarPor(int id) {
		if(id > 0) {
			...
			if (categoriaEncontrada == null) {
				throw new IllegalArgumentException("Não foi encontrada a categoria do código informado");
			}
	...
	private void validar(Categoria categoria) {
		if(categoria != null) {
			...
			throw new NullPointerException("A categoria não pode ser nula e deve possuir entre 3 e 100 caracteres rapa!");
		}
	}
